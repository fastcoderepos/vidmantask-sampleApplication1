...
import com.fastcode.timesheet.addons.docmgmt.domain.file.IFileContentStore;
import com.fastcode.timesheet.addons.docmgmt.domain.file.IFileRepository;
import com.fastcode.timesheet.addons.email.application.mail.dto.CreateEmailInput;
import com.fastcode.timesheet.addons.email.domain.emailattachments.EmailAttachments;
import com.fastcode.timesheet.addons.email.domain.emailattachments.EmailAttachmentsRepository;
import com.fastcode.timesheet.addons.email.domain.emailhistory.EmailHistory;
import com.fastcode.timesheet.addons.email.domain.emailhistory.EmailHistoryRepository;
