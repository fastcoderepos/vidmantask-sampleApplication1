...
import com.fastcode.timesheet.addons.reporting.domain.dashboard.QDashboardEntity;
...
public class DashboardAppService implements IDashboardAppService {
    ...
    public void delete(Long dashboardId, Long userId) {
        ...
        existing.removeDashboardversion(
            _dashboardversionRepository.findById(new DashboardversionId(userId, dashboardId, "running")).get()
        );
        existing.removeDashboardversion(
    ...
    public void deleteReportFromDashboard(Long dashboardId, Long reportId, Long userId) {
        DashboardversionreportEntity existing = _reportDashboardRepository
