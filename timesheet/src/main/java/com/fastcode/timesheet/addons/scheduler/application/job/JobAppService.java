package com.fastcode.timesheet.addons.scheduler.application.job;

import com.fastcode.timesheet.TimesheetApplication;
import com.fastcode.timesheet.addons.scheduler.CGenClassLoader;
import com.fastcode.timesheet.addons.scheduler.application.job.dto.*;
import com.fastcode.timesheet.addons.scheduler.constants.QuartzConstants;
import com.fastcode.timesheet.addons.scheduler.domain.job.IJobRepository;
import com.fastcode.timesheet.addons.scheduler.domain.job.JobEntity;
import com.fastcode.timesheet.addons.scheduler.domain.job.QJobEntity;
import com.fastcode.timesheet.addons.scheduler.domain.jobhistory.IJobHistoryRepository;
import com.fastcode.timesheet.addons.scheduler.domain.jobhistory.JobHistoryEntity;
import com.fastcode.timesheet.addons.scheduler.domain.jobhistory.QJobHistoryEntity;
...
public class JobAppService implements IJobAppService {
    ...
    public List<String> listAllJobClasses() throws URISyntaxException {
        ...
        URI uri = TimesheetApplication.class.getResource("/").toURI();
